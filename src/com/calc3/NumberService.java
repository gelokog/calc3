...
class NumberService {
    ...
    static Num parseAndValidate(String symbol) throws Exception {
    ...
    static Num parseAndValidate(String symbol, NumberType type) throws Exception {

        Num number = parseAndValidate(symbol);
